...
<form name="detailForm" action="/listProduct.do?menu=${param.menu}&orderby=${param.orderby}" method="post">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		...
		<td align="right">
			<a href="/listProduct.do?menu=search&orderby=regdate">신상품순</a>
			|
			<a href="/listProduct.do?menu=search&orderby=lowprice">낮은가격순</a>
			|
			<a href="/listProduct.do?menu=search&orderby=highprice">높은가격순</a>
